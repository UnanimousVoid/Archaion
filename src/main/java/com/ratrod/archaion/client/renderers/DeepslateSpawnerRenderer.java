...
public class DeepslateSpawnerRenderer implements BlockEntityRenderer<DeepslateSpawnerBlockEntity, SpawnerRenderState> {

    private final EntityRenderDispatcher entityRenderer;

    public DeepslateSpawnerRenderer(BlockEntityRendererProvider.Context context) {
    ...
    @Override
    public void extractRenderState(DeepslateSpawnerBlockEntity blockEntity, SpawnerRenderState state, float partialTicks, Vec3 cameraPosition, ModelFeatureRenderer.@Nullable CrumblingOverlay breakProgress) {
    ...
    @Override
    public AABB getRenderBoundingBox(DeepslateSpawnerBlockEntity blockEntity) {
