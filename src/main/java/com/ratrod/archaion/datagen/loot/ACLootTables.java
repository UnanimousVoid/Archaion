...
public class ACLootTables {
    ...
    public static final ResourceKey<LootTable> DEEPSLATE_SPAWNER_MISC = ResourceKey.create(Registries.LOOT_TABLE, Archaion.prefix("spawners/trial_chamber/deepslate_spawner_misc"));
    public static final ResourceKey<LootTable> DEEPSLATE_SPAWNER_KEY = ResourceKey.create(Registries.LOOT_TABLE, Archaion.prefix("spawners/trial_chamber/deepslate_spawner_key"));
    public static final ResourceKey<LootTable> DEEPSLATE_SPAWNER_THROWABLES = ResourceKey.create(Registries.LOOT_TABLE, Archaion.prefix("spawners/trial_chamber/deepslate_spawner_throwables"));
