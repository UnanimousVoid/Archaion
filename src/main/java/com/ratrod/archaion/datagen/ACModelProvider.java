...
public class ACModelProvider extends ModelProvider {
    ...
    protected void registerModels(BlockModelGenerators blockModels, ItemModelGenerators itemModels) {
        ...
        itemModels.generateFlatItem(ACItems.HAUNTER_SPAWN_EGG.get(), ModelTemplates.FLAT_ITEM);
        ...
        ItemModel.Unbaked pulling2 = ItemModelUtils.plainModel(itemModels.createFlatItemModel(ACItems.ECHOS_GRACE.get(), "_pulling_2", ModelTemplates.BOW));
        itemModels.itemModelOutput.accept(ACItems.ECHOS_GRACE.get(), ItemModelUtils.conditional(ItemModelUtils.isUsingItem(), ItemModelUtils.rangeSelect(new EchosGracePull(), 1.0F, pulling0, ItemModelUtils.override(pulling1, 0.65F), ItemModelUtils.override(pulling2, 0.9F)), bowModel));
