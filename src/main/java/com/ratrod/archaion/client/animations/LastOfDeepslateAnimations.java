...
public class LastOfDeepslateAnimations {
	public static final AnimationDefinition WALK_UPPER = AnimationDefinition.Builder.withLength(2.1667F).looping()
		...
		.addAnimation("armr", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(1.0417F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 32.5F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.75F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 32.5F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.7917F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 55.0F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("arml", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(1.75F, KeyframeAnimations.degreeVec(0.0F, 0.0F, -32.5F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.7917F, KeyframeAnimations.degreeVec(0.0F, 0.0F, -47.5F), AnimationChannel.Interpolations.CATMULLROM),
