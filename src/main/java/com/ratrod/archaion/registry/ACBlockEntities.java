...
public class ACBlockEntities {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<DeepslateSpawnerBlockEntity>> DEEPSLATE_TRIAL_SPAWNER = BLOCK_ENTITIES.register("deepslate_trial_spawner",
            () -> new BlockEntityType<>(DeepslateSpawnerBlockEntity::new, Set.of(ACBlocks.DEEPSLATE_SPAWNER.get()))
    );
