...
public class ACItems {
    ...
    public static final DeferredItem<Item> HAUNTER_SPAWN_EGG = ITEM.registerItem("haunter_spawn_egg", SpawnEggItem::new, () -> new Item.Properties().spawnEgg(ACEntityTypes.HAUNTER.get()));
