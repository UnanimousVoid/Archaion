    ...
    public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> output) {
        ...
        output.accept(ACLootTables.DEEPSLATE_VAULT, LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        ...
                        .add(LootItem.lootTableItem(Items.GOLDEN_CARROT).setWeight(6).apply(SetItemCountFunction.setCount(UniformGenerator.between(6.0F, 8.0F))))
                        .add(LootItem.lootTableItem(Items.GOLD_INGOT).setWeight(6).apply(SetItemCountFunction.setCount(UniformGenerator.between(8.0F, 16.0F))))
                        .add(LootItem.lootTableItem(ACItems.ECHO_CHARGE).setWeight(5).apply(SetItemCountFunction.setCount(UniformGenerator.between(4.0F, 8.0F))))
                        .add(LootItem.lootTableItem(Items.ENCHANTED_BOOK).setWeight(5).apply(new SetEnchantmentsFunction.Builder().withEnchantment(enchantments.getOrThrow(Enchantments.MENDING), ConstantValue.exactly(1.0F))))
                        .add(LootItem.lootTableItem(Items.ENCHANTED_BOOK).setWeight(4).apply(new SetEnchantmentsFunction.Builder().withEnchantment(enchantments.getOrThrow(Enchantments.UNBREAKING), UniformGenerator.between(2.0F, 3.0F))))
                        .add(LootItem.lootTableItem(Items.ENCHANTED_BOOK).setWeight(4).apply(new SetEnchantmentsFunction.Builder().withEnchantment(enchantments.getOrThrow(Enchantments.SHARPNESS), UniformGenerator.between(2.0F, 5.0F))))
                        .add(LootItem.lootTableItem(Items.ENCHANTED_BOOK).setWeight(4).apply(new SetEnchantmentsFunction.Builder().withEnchantment(enchantments.getOrThrow(Enchantments.POWER), UniformGenerator.between(2.0F, 5.0F))))
