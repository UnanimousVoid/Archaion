...
public class BraveModel<S extends ACLivingEntityRenderState> extends ACAnimatedModel<S> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = base.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 30).addBox(-6.0F, -26.0F, -6.0F, 12.0F, 26.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 18.0F, 0.0F));

		PartDefinition rods = base.addOrReplaceChild("rods", CubeListBuilder.create(), PartPose.offset(0.0F, 12.0F, 0.0F));

		PartDefinition rod2 = rods.addOrReplaceChild("rod2", CubeListBuilder.create().texOffs(48, 30).addBox(-2.6F, -5.0F, -2.6F, 5.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -1.0F, 14.6F));

		PartDefinition rod1 = rods.addOrReplaceChild("rod1", CubeListBuilder.create().texOffs(48, 30).addBox(-2.6F, -5.0F, -2.4F, 5.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -1.0F, -14.6F));
		...
		PartDefinition rod3 = rodgroup.addOrReplaceChild("rod3", CubeListBuilder.create().texOffs(48, 30).addBox(-2.6F, -5.0F, -2.6F, 5.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 15.0F));

		PartDefinition rod4 = rodgroup.addOrReplaceChild("rod4", CubeListBuilder.create().texOffs(48, 30).addBox(-2.6F, -5.0F, -2.4F, 5.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, -14.2F));
