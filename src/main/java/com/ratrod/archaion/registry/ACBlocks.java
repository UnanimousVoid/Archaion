...
public class ACBlocks {
    ...
    public static final DeferredBlock<Block> DEEPSLATE_PILLAR = registerBlock("deepslate_pillar", RotatedPillarBlock::new, properties -> properties.mapColor(MapColor.DEEPSLATE).instrument(NoteBlockInstrument.BASEDRUM).sound(SoundType.DEEPSLATE).strength(4.5F, 1200.0F));
    public static final DeferredBlock<Block> SOUL_LAMP = registerBlock("soul_lamp", Block::new, properties -> properties.mapColor(MapColor.QUARTZ).instrument(NoteBlockInstrument.HAT).strength(0.3F).sound(SoundType.GLASS).lightLevel((state) -> 15));
    public static final DeferredBlock<Block> REINFORCED_GRATE = registerBlock("reinforced_grate", WaterloggedTransparentBlock::new, properties -> properties.mapColor(MapColor.DEEPSLATE).instrument(NoteBlockInstrument.BASEDRUM).sound(SoundType.COPPER_GRATE).strength(55.0F, 1200.0F).noOcclusion());
    public static final DeferredBlock<Block> REINFORCED_CHAIN = registerBlock("reinforced_chain", ChainBlock::new, properties -> properties.mapColor(MapColor.DEEPSLATE).instrument(NoteBlockInstrument.BASEDRUM).sound(SoundType.CHAIN).strength(55.0F, 1200.0F).noOcclusion());
