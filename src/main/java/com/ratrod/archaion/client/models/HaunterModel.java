...
public class HaunterModel<T extends ACLivingEntityRenderState> extends ACAnimatedModel<T> {
    ...
    public HaunterModel(ModelPart root) {
        ...
        this.walkAnimation = HaunterAnimations.WALK.bake(root);
    ...
    public void setupAnim(T state) {
        ...
        this.animateScaled(HaunterAnimations.IDLE, state.ageInTicks, 1.0F, 1.0F);
